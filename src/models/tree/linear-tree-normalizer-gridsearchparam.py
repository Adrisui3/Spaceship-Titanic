...
param_grid = {'criterion' : ["hamming", "crossentropy"], 'max_depth': [10,20], 'min_samples_split': [15,20], 
              'min_samples_leaf':[50,60], 'max_bins':[25]}
...
# best_params
best_params
# {'criterion': 'hamming', 'max_bins': 25, 'max_depth': 10, 'min_samples_leaf': 60, 'min_samples_split': 15}
# crossentropy necesita que el estimador use el método predict_proba, parece que obtiene buena precisión, probamos afinar los params
...
utils.generate_submission(labels = pred_labels, method = "tree", notes = "LinearTree_ridge_normalizer_gridsearch_parameters")
