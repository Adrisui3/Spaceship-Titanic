...
grid_parameters = {'criterion':['gini'], 'splitter':['best'], 'max_depth':list(range(10,20)), 'min_samples_split':list(range(55,65)), 
                   'min_samples_leaf':list(range(5,16)), 'max_features':['sqrt'],  
...
dtc_gs.best_score_
# mejor resultado con 0.7805181011335529
dtc_gs.best_params_
# 'ccp_alpha': 0.001,
# 'criterion': 'gini',
# 'max_depth': 14,
...
# 'splitter': 'best'}
# mejora, pero voy a probar con ccp_alpha más pequeño y una búsqueda más extensa de los otros parámetros
...
utils.generate_submission(labels = true_labels, method = "tree", notes = "gridSearch_parameters5")
