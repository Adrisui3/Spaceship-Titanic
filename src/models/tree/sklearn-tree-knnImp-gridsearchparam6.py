...
dtc_gs.best_score_
# mejor resultado con 0.7886870891366745
dtc_gs.best_params_
# {'ccp_alpha': 0.0003,
# 'criterion': 'gini',
# 'max_depth': 12,
...
# 'splitter': 'best'}
# mejora con knn, pruebo normalización
...
utils.generate_submission(labels = true_labels, method = "tree", notes = "knnImp_gridSearch_parameters6")
