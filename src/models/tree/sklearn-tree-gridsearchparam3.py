...
grid_parameters = {'criterion':['gini', 'entropy', 'log_loss'], 'splitter':['best','random'], 'max_depth':list(range(10,25)), 'min_samples_split':list(range(30,70)), 
                   'min_samples_leaf':list(range(1,20)), 'max_features':['None', 'sqrt', 'log2']}
...
dtc_gs.best_score_
# mejor resultado con 0.7835092522783487
dtc_gs.best_params_
