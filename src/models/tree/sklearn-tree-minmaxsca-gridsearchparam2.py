...
dtc_gs.best_score_
# mejor resultado con 0.784774545983625
dtc_gs.best_params_
# 'ccp_alpha': 0.0002,
# 'criterion': 'gini',
# 'max_depth': 16,
...
# 'splitter': 'best'}
# Misma precisión, parece que el escalado no afecta al no tener un clasificador
# basado en distancia
...
utils.generate_submission(labels = true_labels, method = "tree", notes = "minmaxsca_gridSearch_parameters2")
