...
dtc_gs.best_score_
# mejor resultado con 0.799382828723728
dtc_gs.best_params_
# {'ccp_alpha': 0.00042,
# 'criterion': 'gini',
# 'max_depth': 22,
...
utils.generate_submission(labels = true_labels, method = "tree", notes = "normalizer_KnnImp_gridSearch_parameters2")
