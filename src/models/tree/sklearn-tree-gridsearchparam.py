...
grid_parameters = {'criterion':['gini', 'entropy', 'log_loss'], 'splitter':['best','random'], 'min_samples_split':list(range(2,101)), 
                   'min_samples_leaf':list(range(1,101)), 'max_features':['None', 'sqrt', 'log2']}
