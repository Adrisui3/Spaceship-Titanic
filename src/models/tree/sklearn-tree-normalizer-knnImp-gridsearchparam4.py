...
grid_parameters = {'criterion':['gini'], 'splitter':['best'], 'max_depth':list(range(10,25)), 'min_samples_split':list(range(35,60)), 
                   'min_samples_leaf':list(range(2,15)), 'max_features':['sqrt'],  
                   'ccp_alpha':[0.0005,0.0006,0.0007,0.0008,0.0009]}
...
dtc_gs.best_score_
# mejor resultado con 0.7986934380910811
dtc_gs.best_params_
# {'ccp_alpha': 0.0005,
# 'criterion': 'gini',
# 'max_depth': 17,
...
# 'splitter': 'best'}
# mejora con respecto al anterior, hay que bajar ccp_alpha
...
utils.generate_submission(labels = true_labels, method = "tree", notes = "normalizer_knnImp_gridSearch_parameters4")
