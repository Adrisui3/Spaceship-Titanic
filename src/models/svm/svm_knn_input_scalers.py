...
print("\n--- MIN MAX SCALER ---")
train_X_mm = utils.minmax_scaler_oh(df = train_X)
...
print("\n--- STANDARD SCALER ---")
train_X_sc = utils.standard_scaler_oh(df = train_X)
...
#test = utils.standard_scaler_oh(df = test)
...
print("\n--- ROBUST SCALER ---")
train_X_rs = utils.robust_scaler_oh(df = train_X)
...
print("\n--- NORMALIZER ---")
train_X_norm = utils.normalizer_oh(df = train_X)
